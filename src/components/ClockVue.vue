        ...
        <svg version="1.1"  :class="TownName" x="0px" y="0px" width="150px" height="150px" viewBox="0 0 384 384" enable-background="new 0 0 384 384" xml:space="preserve">
            ...
            <defs>
                <animateTransform
                    ...
                    :xlink:href=classHtml[7] repeatCount="indefinite"
                    dur="43200s" to="360 192 192" from="0 192 192" attributeName="transform" attributeType="xml">
                </animateTransform>

                <animateTransform
                    type="rotate" fill="remove" restart="always" calcMode="linear" accumulate="none" additive="sum"
                    :xlink:href=classHtml[8] repeatCount="indefinite" dur="3600s" to="360 192 192"
                    from="0 192 192" attributeName="transform" attributeType="xml">
                </animateTransform>

                <animateTransform
                    type="rotate" fill="remove" restart="always" calcMode="linear" accumulate="none" additive="sum" 
                    :xlink:href=classHtml[9] repeatCount="indefinite"
